        ...
        >
          <div className="flex items-start justify-between gap-4">
            ...
            <button
              ...
              className="shrink-0 rounded-lg border border-indigo-300 px-3 py-2 text-sm font-semibold text-indigo-700 transition hover:bg-indigo-50 dark:border-indigo-800 dark:text-indigo-300 dark:hover:bg-indigo-950/30"
            >
              Overview &amp; release
            </button>
