 ...
 * button. Scalar fields (grad year, GPA, intended major, goals) plus SAT/ACT
 * folded into the `test_scores` jsonb object, plus an editable `activities`
 * jsonb list (add/remove rows with name/role/hours). A "dirty" flag gates Save;
 * saving UPDATEs by id when a row exists, else INSERTs, then refetches.
 */
        ...
        <div className="space-y-5">
          ...
          <label className="block space-y-1.5">
            ...
            <textarea
              ...
              rows={4}
              placeholder="Counseling goals, target schools, notes…"
