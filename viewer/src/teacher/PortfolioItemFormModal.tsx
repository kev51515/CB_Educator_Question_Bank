...
export function PortfolioItemFormModal({
  ...
  return (
    <ResponsiveModal
      ...
      subtitle="Define a requirement students will complete in their portfolio."
      size="lg"
      dismissible={!busy}
      footer={
    ...
    >
      <form id="portfolio-item-form" onSubmit={submit} className="space-y-4">
        {error && (
            <div
              role="alert"
