...
_Last updated: 2026-06-05 (through 0109 — proctor timeline + per-test proctoring
level (0108) + a `start_test` `results_released` hotfix (0109); both applied to
Remote, `migration list` Local==Remote, clickthrough 42/42 + edge 10/10 + full
smoke all-green. Prior: 0107 — hot-path FK indexes, applied to Remote,
