...
Miss Pyne sat by the window watching, in her best dress, looking stately and calm; she seldom went out now, and it was almost time for the carriage. Martha was just coming in from the garden with the strawberries, and with more flowers in her apron. It was a bright cool evening in June, the golden robins sang in the elms, and the sun was going down behind the apple-trees at the foot of the garden. The beautiful old house stood wide open to the long-expected guest.', NULL, 'Which choice best states the main purpose of the text?', '{"A":"To convey the worries brought about by a new guest","B":"To describe how the characters have changed over time","C":"To contrast the activity indoors with the stillness outside","D":"To depict the setting as the characters await a visitor’s arrival"}'::jsonb, NULL, 'D', NULL, NULL, 7)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 11, '1-11', 11, 'mcq', 'The following text is from Jane Austen’s 1811 novel Sense and Sensibility. Elinor lives with her younger sisters and her mother, Mrs. Dashwood.
...
[Bar graph — Percentage of Ondo State Small-Scale Farmers Who Are Female, by Main Crop Grown. Y-axis: Female farmers as a percentage of total (0 to 60). X-axis: Ondo State region (north Ondo, central Ondo, south Ondo). Legend: cereals, root crops, non–root vegetables.]

(Figure: Bar graph titled “Percentage of Ondo State Small-Scale Farmers Who Are Female, by Main Crop Grown.” Y-axis: Female farmers as a percentage of total (0–60). X-axis (Ondo State region): north Ondo, central Ondo, south Ondo. Legend (bars per region): cereals, root crops, non–root vegetables.)', 'Bar graph titled “Percentage of Ondo State Small-Scale Farmers Who Are Female, by Main Crop Grown.” Y-axis: Female farmers as a percentage of total (0–60). X-axis (Ondo State region): north Ondo, central Ondo, south Ondo. Legend (bars per region): cereals, root crops, non–root vegetables.', 'Which choice most effectively uses data from the graph to complete the example?', '{"A":"most of the farmers who mainly cultivated cereals and most of the farmers who mainly cultivated non–root vegetables in south Ondo were women.","B":"more women in central Ondo mainly cultivated root crops than mainly cultivated cereals.","C":"most of the farmers who mainly cultivated non–root vegetables in north and south Ondo were women.","D":"a relatively equal proportion of women across the three regions of Ondo mainly cultivated cereals."}'::jsonb, NULL, 'C', NULL, NULL, 9)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
Which choice completes the text with the most logical and precise word or phrase?', '{"A":"struggling","B":"beneficial","C":"simple","D":"healthy"}'::jsonb, NULL, 'D', NULL, NULL, 18)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 2, '2-2', 2, 'mcq', NULL, NULL, 'Nigerian American author Teju Cole''s ______ his two passions—photography and the written word—culminates in his 2017 book, Blind Spot, which evocatively combines his original photographs from his travels with his poetic prose.
...
Which choice completes the text with the most logical and precise word or phrase?', '{"A":"question","B":"react to","C":"perceive","D":"conform to"}'::jsonb, NULL, 'D', NULL, NULL, 18)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 4, '2-4', 4, 'mcq', NULL, NULL, 'In Nature Poem (2017), Kumeyaay poet Tommy Pico portrays his ______ the natural world by bouncing between the centrality of nature within his tribe''s traditional beliefs while simultaneously expressing his distaste for being in wilderness settings himself.
...
When hibernating, Alaska marmots and Arctic ground squirrels enter a state called torpor, which minimizes the energy their bodies need to function. Often a hibernating animal will temporarily come out of torpor (called an arousal episode) and its metabolic rate will rise, burning more of the precious energy the animal needs to survive the winter. Alaska marmots hibernate in groups and therefore burn less energy keeping warm during these episodes than they would if they were alone. A researcher hypothesized that because Arctic ground squirrels hibernate alone, they would likely exhibit longer bouts of torpor and shorter arousal episodes than Alaska marmots.', NULL, 'Which choice best describes data from the table that support the researcher''s hypothesis?', '{"A":"The Alaska marmots'' arousal episodes lasted for days, while the Arctic ground squirrels'' arousal episodes lasted less than a day.","B":"The Alaska marmots and the Arctic ground squirrels both maintained torpor for several consecutive days per bout, on average.","C":"The Alaska marmots had shorter torpor bouts and longer arousal episodes than the Arctic ground squirrels did.","D":"The Alaska marmots had more torpor bouts than arousal episodes, but their arousal episodes were much shorter than their torpor bouts."}'::jsonb, NULL, 'C', NULL, NULL, 25)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 23, '2-23', 23, 'mcq', 'Materials scientist Marie-Agathe Charpagne and her colleagues believed they could improve on the multicomponent alloy NiCoCr, an equal-proportion mixture of nickel (Ni), cobalt (Co), and chromium (Cr), by replacing chromium with ruthenium (Ru), an element that''s similar to chromium ______ the alloy that resulted, NiCoRu, turned out to be an unsuitable replacement for NiCoCr.', NULL, 'Which choice completes the text so that it conforms to the conventions of Standard English?', '{"A":"(Ru).","B":"(Ru) but","C":"(Ru),","D":"(Ru), but"}'::jsonb, NULL, 'D', NULL, NULL, 27)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 31, '2-31', 31, 'mcq', 'When designing costumes for films, American artist Surtirat Larlarb typically custom fits the garments to each actor. ______ for the film Sunshine, in which astronauts must reignite a dying Sun, she designed a golden spacesuit and had a factory reproduce it in a few standard sizes; lacking a tailor-made quality, the final creations reflected the unguardliness of actual spacesuits.', NULL, 'Which choice completes the text with the most logical transition?', '{"A":"Nevertheless,","B":"Thus,","C":"Likewise,","D":"Moreover,"}'::jsonb, NULL, 'A', NULL, NULL, 29)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
The student wants to emphasize a similarity between the two books by Shaun Tan. Which choice most effectively uses relevant information from the notes to accomplish this goal?', NULL, 'The student wants to emphasize a similarity between the two books by Shaun Tan. Which choice most effectively uses relevant information from the notes to accomplish this goal?', '{"A":"Shaun Tan''s book Tales from Outer Suburbia, which describes surreal events occurring in otherwise ordinary places, contains more short stories than his book Tales from the Inner City does.","B":"Tales from Outer Suburbia was published in 2008, and Tales from the Inner City was published in 2018.","C":"Unlike Tales from the Inner City, Shaun Tan''s book Tales from Outer Suburbia is set in suburban neighborhoods.","D":"Shaun Tan''s books Tales from Outer Suburbia and Tales from the Inner City both describe surreal events occurring in otherwise ordinary settings."}'::jsonb, NULL, 'D', NULL, NULL, 30)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
• Men''s team-obtained clutch-size and habitat data for over 3,900 lizard species and analyzed the data with statistical models.
...
What is the solution to the given equation?', '{"A":"28","B":"324","C":"348","D":"4,032"}'::jsonb, NULL, 'B', NULL, NULL, 32)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 4, '3-4', 4, 'mcq', '(Figure: A transversal line labeled ℓ crosses two parallel vertical lines labeled m and n (m on the left, n on the right), descending from upper-left to lower-right. The angle the transversal makes at line m, above the transversal and to the right, is labeled x°. The angle the transversal makes at line n, below the transversal, is labeled 26°. Note: Figure not drawn to scale.)', 'A transversal line labeled ℓ crosses two parallel vertical lines labeled m and n (m on the left, n on the right), descending from upper-left to lower-right. The angle the transversal makes at line m, above the transversal and to the right, is labeled x°. The angle the transversal makes at line n, below the transversal, is labeled 26°. Note: Figure not drawn to scale.', 'In the figure shown, line $m$ is parallel to line $n$. What is the value of $x$ ?', '{"A":"13","B":"26","C":"52","D":"154"}'::jsonb, NULL, 'D', NULL, NULL, 32)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 7, '3-7', 7, 'grid', '(Figure: A vertical bar graph titled with y-axis "Number of cans" (gridlines at 0, 10, 20, 30, 40, 50, 60, 70) and x-axis "Group" (groups 1 through 10). Approximate bar heights: group 1 ≈ 30, group 2 ≈ 63, group 3 ≈ 38, group 4 ≈ 50, group 5 ≈ 47, group 6 ≈ 40, group 7 ≈ 54, group 8 ≈ 60, group 9 ≈ 17, group 10 ≈ 20.)', 'A vertical bar graph titled with y-axis "Number of cans" (gridlines at 0, 10, 20, 30, 40, 50, 60, 70) and x-axis "Group" (groups 1 through 10). Approximate bar heights: group 1 ≈ 30, group 2 ≈ 63, group 3 ≈ 38, group 4 ≈ 50, group 5 ≈ 47, group 6 ≈ 40, group 7 ≈ 54, group 8 ≈ 60, group 9 ≈ 17, group 10 ≈ 20.', 'The bar graph shows the distribution of 419 cans collected by 10 different groups for a food drive. How many cans were collected by group 6?', NULL, NULL, '40', '["40"]'::jsonb, NULL, 33)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
Which of the following could describe this function?', '{"A":"Decreasing exponential","B":"Decreasing linear","C":"Increasing exponential","D":"Increasing linear"}'::jsonb, NULL, 'D', NULL, NULL, 36)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 24, '3-24', 24, 'mcq', '(Figure: An xy-coordinate grid with x-axis from about -10 to 0 and y-axis from about 0 down to -10 (y-axis labeled at top, x-axis to the right, origin O at upper right). A curve enters near (-10, -0.7), stays close to the x-axis on the left, then curves sharply downward as x increases, dropping steeply near x = -4 toward y = -10. The curve approaches a vertical asymptote around x = -4.)', 'An xy-coordinate grid with x-axis from about -10 to 0 and y-axis from about 0 down to -10 (y-axis labeled at top, x-axis to the right, origin O at upper right). A curve enters near (-10, -0.7), stays close to the x-axis on the left, then curves sharply downward as x increases, dropping steeply near x = -4 toward y = -10. The curve approaches a vertical asymptote around x = -4.', 'The rational function $f$ is defined by an equation in the form $f(x) = \dfrac{a}{x + b}$, where $a$ and $b$ are constants. The partial graph of $y = f(x)$ is shown. If $g(x) = f(x + 4)$, which equation could define function $g$ ?', '{"A":"$g(x) = \\dfrac{6}{x}$","B":"$g(x) = \\dfrac{6}{x + 4}$","C":"$g(x) = \\dfrac{6}{x + 8}$","D":"$g(x) = \\dfrac{6(x + 4)}{x + 4}$"}'::jsonb, NULL, 'C', NULL, NULL, 37)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 2, '4-2', 2, 'mcq', '(Figure: An exponential-type curve is plotted in the xy-plane on a grid with both axes labeled from about -5 to 10. The curve rises steeply from left to right, crossing the y-axis at the point (0, 2).)', 'An exponential-type curve is plotted in the xy-plane on a grid with both axes labeled from about -5 to 10. The curve rises steeply from left to right, crossing the y-axis at the point (0, 2).', 'What is the $y$-intercept of the graph shown?', '{"A":"$(0, 0)$","B":"$(0, 2)$","C":"$(2, 0)$","D":"$(2, 2)$"}'::jsonb, NULL, 'B', NULL, NULL, 42)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
$y = x^2 + 8$', NULL, 'The graphs of the equations in the given system of equations intersect at the point $(x, y)$ in the $xy$-plane. What is the value of $y$ ?', '{"A":"8","B":"24","C":"64","D":"72"}'::jsonb, NULL, 'D', NULL, NULL, 43)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 11, '4-11', 11, 'mcq', 'The scatterplot shows the relationship between two variables, $x$ and $y$. A line of best fit is also shown.

(Figure: A scatterplot in the first quadrant with the x-axis labeled from 0 to 14 and the y-axis labeled from 0 to about 15. Several data points are scattered with an overall decreasing trend. A line of best fit is drawn that starts near (0, 13.5) and slopes downward to the right with a negative slope of about -0.8, passing near (14, 2).)', 'A scatterplot in the first quadrant with the x-axis labeled from 0 to 14 and the y-axis labeled from 0 to about 15. Several data points are scattered with an overall decreasing trend. A line of best fit is drawn that starts near (0, 13.5) and slopes downward to the right with a negative slope of about -0.8, passing near (14, 2).', 'Which of the following equations best represents the line of best fit shown?', '{"A":"$y = 13.5 + 0.8x$","B":"$y = 13.5 - 0.8x$","C":"$y = -13.5 + 0.8x$","D":"$y = -13.5 - 0.8x$"}'::jsonb, NULL, 'B', NULL, NULL, 44)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
$2x + 2y = 10$', NULL, 'The solution to the given system of equations is $(x, y)$. What is the value of $y$ ?', '{"A":"$-2$","B":"7","C":"14","D":"18"}'::jsonb, NULL, 'A', NULL, NULL, 45)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 24, '4-24', 24, 'mcq', '(Figure: Two dot plots side by side, labeled Data Set A and Data Set B, sharing a horizontal value axis labeled from 10 through 18. Each dot plot shows the frequency distribution of values as stacked dots above the value axis; the two distributions appear similar in spread and center.)', 'Two dot plots side by side, labeled Data Set A and Data Set B, sharing a horizontal value axis labeled from 10 through 18. Each dot plot shows the frequency distribution of values as stacked dots above the value axis; the two distributions appear similar in spread and center.', 'The dot plots represent the distributions of values in data sets A and B.

Which of the following statements must be true?
I. The median of data set A is equal to the median of data set B.
II. The standard deviation of data set A is equal to the standard deviation of data set B.', '{"A":"I only","B":"II only","C":"I and II","D":"Neither I nor II"}'::jsonb, NULL, 'A', NULL, NULL, 46)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
