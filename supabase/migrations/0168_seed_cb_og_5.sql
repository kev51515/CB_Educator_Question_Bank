...
At supper time, Fox-Foot would allow no fire to be built, no landing to be made, no trace of their passing to be left. They ate canned meat and marmalade, drank again of the stream and pushed on, until just at dusk they reached the edge of a long, still lake, with shores of granite and dense fir forest.', NULL, 'As used in the text, what does the word “trace” most nearly mean?', '{"A":"Evidence","B":"Blemish","C":"Amount","D":"Sketch"}'::jsonb, NULL, 'A', NULL, NULL, 4)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 6, '1-6', 6, 'mcq', 'The following text is adapted from Jean Webster’s 1912 novel Daddy-Long-Legs. The narrator is a young college student writing letters detailing her weekly experiences.
...
The passage of time is among the many obstacles faced by scientists who are pursuing de-extinction efforts—that is, efforts to use breeding or a mixture of cloning and genetic engineering to bring back extinct species. Specifically, researchers are concerned that the longer a species has been extinct, the less likely it is that a suitable habitat still exists for that species. Among candidate species for de-extinction, this problem would be especially concerning for the ______', NULL, 'Which choice most effectively uses data from the table to complete the statement?', '{"A":"passenger pigeon (Ectopistes migratorius), which became extinct only a few years after the huia (Heteralocha acutirostris).","B":"saber-toothed cat (Smilodon), which became extinct 11,000 years ago.","C":"woolly mammoth (Mammuthus primigenius), which became extinct several thousand years before the saber-toothed cat (Smilodon).","D":"Caribbean monk seal (Monachus tropicalis), which became extinct in 1952."}'::jsonb, NULL, 'B', NULL, NULL, 9)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
(Figure: Line graph titled “Ratio of Manganese to Calcium in Samples from Alboran Sea and Mauritanian Coast.” X-axis: Approximate years before present (in thousands), values 2 to 20. Y-axis: manganese-to-calcium ratio, values 0 to 100. Two plotted series: Alboran Sea and Mauritanian coast.)', 'Line graph titled “Ratio of Manganese to Calcium in Samples from Alboran Sea and Mauritanian Coast.” X-axis: Approximate years before present (in thousands), values 2 to 20. Y-axis: manganese-to-calcium ratio, values 0 to 100. Two plotted series: Alboran Sea and Mauritanian coast.', 'Which choice most effectively uses data from the graph to complete the statement?', '{"A":"a substantial increase in oxygenation in the Alboran Sea corresponded with the local decline in L. pertusa, but the opposite relationship between oxygenation and L. pertusa was found near the Mauritanian coast.","B":"L. pertusa declined in the Alboran Sea during a period of substantial local decline in oxygenation, but L. pertusa declined near the Mauritanian coast during a period of little local change in oxygenation.","C":"oxygenation in the Alboran Sea was higher before the decline in L. pertusa than after the decline, whereas oxygenation near the Mauritanian coast was relatively low both before and after the decline in L. pertusa.","D":"oxygenation in the Alboran Sea tended to be substantially higher than oxygenation near the Mauritanian coast during the period studied."}'::jsonb, NULL, 'B', NULL, NULL, 10)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 26, '1-26', 26, 'mcq', 'In 1986, conceptual artist Sophie Calle asked twenty-three people, all of whom had been born without sight, to describe “their image of beauty” in rich detail. Calle paired excerpts of these conversations with photographs—both of interviewees and the items they ______ to powerful effect in her exhibition The Blind.', NULL, 'Which choice completes the text so that it conforms to the conventions of Standard English?', '{"A":"described, from hair to grass to sculptures","B":"described, from hair to grass to sculptures—","C":"described—from hair to grass to sculptures,","D":"described: from hair to grass to sculptures"}'::jsonb, NULL, 'B', NULL, NULL, 14)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
• A woman named Mary Ann Evans later revealed herself as the novel’s real author.', NULL, 'The student wants to identify the real author of Adam Bede. Which choice most effectively uses relevant information from the notes to accomplish this goal?', '{"A":"The real author of Adam Bede was Mary Ann Evans, who published the novel using the pseudonym George Eliot.","B":"George Eliot, which Adam Bede’s title page indicated was the name of the novel’s author, was widely assumed to be a pseudonym.","C":"The title page of the novel Adam Bede indicated that the author’s name was George Eliot.","D":"A woman who had used a pseudonym to conceal her identity later revealed herself as the real author of Adam Bede."}'::jsonb, NULL, 'A', NULL, NULL, 15)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
• The California red-legged frog (Rana draytonii) is likely to soon become endangered, according to the FWS.', NULL, 'The student wants to indicate the California red-legged frog’s FWS classification category. Which choice most effectively uses relevant information from the notes to accomplish this goal?', '{"A":"Species on the FWS list, which includes the California red-legged frog (Rana draytonii), are classified as either endangered or threatened.","B":"The California red-legged frog (Rana draytonii) appears on the FWS list of at-risk species.","C":"According to the FWS, the California red-legged frog is in the endangered category, in danger of extinction throughout most or all of its range.","D":"Likely to soon become endangered, the California red-legged frog is classified as threatened by the FWS."}'::jsonb, NULL, 'D', NULL, NULL, 16)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  ...
  RETURNING id INTO v_mod;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 1, '2-1', 1, 'mcq', 'The following text is adapted from Elizabeth von Arnim''s 1922 novel The Enchanted April. Mrs. Wilkins and her friend Rose are traveling in Italy.
...
Graphic novels present their stories through both language and images. Without captions and dialogue, readers would be unable to understand what is depicted in the illustrations: the story results from the interaction of text and image. Moreover, Alison Bechdel''s Fun Home and many other graphic novels feature text that is as beautifully written as the prose found in many standard novels. Therefore, graphic novels qualify as literary texts.', NULL, 'Based on the texts, how would the author of Text 2 most likely respond to the overall argument presented in Text 1?', '{"A":"By asserting that language plays a more important role in graphic novels than the author of Text 1 recognizes","B":"By acknowledging that the author of Text 1 has identified a flaw that is common to all graphic novels","C":"By suggesting that the story lines of certain graphic novels are more difficult to understand than the author of Text 1 claims","D":"By agreeing with the author of Text 1 that most graphic novels aren''t as well crafted as most literary works are"}'::jsonb, NULL, 'A', NULL, NULL, 21)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 9, '2-9', 9, 'mcq', 'The following text is adapted from Ann Petry''s 1946 novel The Street. Lutie lives in an apartment in Harlem, New York.
...
(Figure: Bar graph titled "Modeled Radial Growth of Sugar Maple Trees"; y-axis Radial growth (millimeters per year), 0–0.25; x-axis Climate scenario (current climate, moderate change, extreme change); two bars per scenario: with nitrogen and without nitrogen.)', 'Bar graph titled "Modeled Radial Growth of Sugar Maple Trees"; y-axis Radial growth (millimeters per year), 0–0.25; x-axis Climate scenario (current climate, moderate change, extreme change); two bars per scenario: with nitrogen and without nitrogen.', 'Which choice best describes data from the graph that support Ibáñez and colleagues'' conclusion?', '{"A":"Growth with nitrogen under the current climate exceeded growth with nitrogen under moderate change, but the latter exceeded growth without nitrogen under extreme change.","B":"Growth without nitrogen under the current climate exceeded growth without nitrogen under moderate change, but the latter exceeded growth with nitrogen under extreme change.","C":"Growth with nitrogen under moderate change exceeded growth without nitrogen under moderate change, but the latter exceeded growth without nitrogen under extreme change.","D":"Growth with nitrogen under moderate change exceeded growth without nitrogen under the current climate, but the latter exceeded growth with nitrogen under extreme change."}'::jsonb, NULL, 'D', NULL, NULL, 24)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
Some climate models for the western United States predict that while total annual precipitation may remain unchanged from the present level, precipitation will become concentrated into fewer but more intense rain and snow events. University of Texas climate scientist Geeta Persad and her colleagues simulated how the amount of water entering aquifers and the amount being used for irrigation purposes would change if this were to occur. Persad and her colleagues concluded that concentration of precipitation into fewer events would result in a higher number of dry days, triggering more irrigation, but that this change in irrigation output is highly sensitive to the baseline concentration of precipitation that currently exists in an area.', NULL, 'Which choice best describes data from the table that support Persad and her colleagues'' conclusion?', '{"A":"If baseline precipitation is somewhat concentrated, the amount of water being used for irrigation will increase 0.4% for surface water and 0.9% for groundwater, whereas the amount of water entering aquifers will increase 11.0% if baseline precipitation is evenly distributed.","B":"If baseline precipitation is somewhat concentrated, water use for irrigation will increase only slightly, whereas it will increase 9.0% for surface water and 7.9% for groundwater if baseline precipitation is evenly distributed.","C":"If baseline precipitation is somewhat concentrated, the amount of water entering aquifers will increase 4.9%, while the amount being used for irrigation will increase 0.4% for surface water and 0.9% for groundwater.","D":"If baseline precipitation is somewhat concentrated, water use for irrigation will decline by a small amount, whereas it will increase 11.0% for surface water and 9.0% for groundwater if baseline precipitation is evenly distributed."}'::jsonb, NULL, 'B', NULL, NULL, 26)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 27, '2-27', 27, 'mcq', 'In 2014, Nestor Gomez won his first-ever storytelling competition, relating a tale about his life as a Guatemalan immigrant living in Chicago. ______ in 2017, Gomez created the show 80 Minutes Around the World as a platform for others to share stories about their immigration experiences.', NULL, 'Which choice completes the text with the most logical transition?', '{"A":"Instead,","B":"For example,","C":"Later,","D":"In other words,"}'::jsonb, NULL, 'C', NULL, NULL, 29)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
The student wants to emphasize a similarity between P waves and S waves.', NULL, 'Which choice most effectively uses relevant information from the notes to accomplish this goal?', '{"A":"P waves and S waves both travel beneath Earth''s surface, causing the ground to move.","B":"P waves travel away from an earthquake''s starting point at a higher rate of speed than do S waves.","C":"Spreading out from the focus of an earthquake, P waves move the ground backward and forward.","D":"Although P waves and S waves start at the same point, they behave very differently."}'::jsonb, NULL, 'A', NULL, NULL, 31)
  ...
  RETURNING id INTO v_mod;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 1, '3-1', 1, 'mcq', '(Figure: An xy-plane with grid, x-axis labeled from -2 to 9 and y-axis labeled from -2 to 9, origin O. A curved (nonlinear) graph starts at about (-2, 4), is nearly horizontal near y = 4, then curves upward to the right passing through about (5, 5) and rising steeply. A straight line passes from upper left, descending steeply through about (3, 9) down through (4, 5) and continuing to about (5, -2). The two graphs intersect at the point (4, 5).)', 'An xy-plane with grid, x-axis labeled from -2 to 9 and y-axis labeled from -2 to 9, origin O. A curved (nonlinear) graph starts at about (-2, 4), is nearly horizontal near y = 4, then curves upward to the right passing through about (5, 5) and rising steeply. A straight line passes from upper left, descending steeply through about (3, 9) down through (4, 5) and continuing to about (5, -2). The two graphs intersect at the point (4, 5).', 'The graph of a system of a linear equation and a nonlinear equation is shown. What is the solution $(x, y)$ to this system?', '{"A":"$(0, 0)$","B":"$(0, 4)$","C":"$(4, 5)$","D":"$(5, 0)$"}'::jsonb, NULL, 'C', NULL, NULL, 34)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 3, '3-3', 3, 'mcq', '(Figure: An xy-plane with grid, x-axis labeled from -2 to 14 (by 2s) and y-axis labeled from -1 to 8, origin O. A straight line with negative slope passes through about (0, 8) on the y-axis and descends to the right, crossing the x-axis at about x = 5.5 and continuing downward to about (7, -1).)', 'An xy-plane with grid, x-axis labeled from -2 to 14 (by 2s) and y-axis labeled from -1 to 8, origin O. A straight line with negative slope passes through about (0, 8) on the y-axis and descends to the right, crossing the x-axis at about x = 5.5 and continuing downward to about (7, -1).', 'The graph of the linear function $f$ is shown, where $y = f(x)$. What is the $y$-intercept of the graph of $f$ ?', '{"A":"$(0, 0)$","B":"$\\left(0, -\\frac{16}{11}\\right)$","C":"$(0, -8)$","D":"$(0, 8)$"}'::jsonb, NULL, 'D', NULL, NULL, 34)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
| 2 | 19 |', NULL, 'Which of the following is the best description of function $f$ ?', '{"A":"Decreasing linear","B":"Increasing linear","C":"Decreasing exponential","D":"Increasing exponential"}'::jsonb, NULL, 'B', NULL, NULL, 35)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 8, '3-8', 8, 'mcq', '(Figure: A transversal line k crosses two parallel lines m and n (m above n). Line k descends from upper right to lower left, crossing line m and then line n. At the intersection of line k with line m, an angle of 145° is marked (interior, to the lower-left of the intersection). An angle x° is associated with the intersection at line n. Note: Figure not drawn to scale.)', 'A transversal line k crosses two parallel lines m and n (m above n). Line k descends from upper right to lower left, crossing line m and then line n. At the intersection of line k with line m, an angle of 145° is marked (interior, to the lower-left of the intersection). An angle x° is associated with the intersection at line n. Note: Figure not drawn to scale.', 'In the figure, line $m$ is parallel to line $n$, and line $k$ intersects both lines. Which of the following statements is true?', '{"A":"The value of $x$ is less than 145.","B":"The value of $x$ is greater than 145.","C":"The value of $x$ is equal to 145.","D":"The value of $x$ cannot be determined."}'::jsonb, NULL, 'C', NULL, NULL, 36)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
$$y = x^2 - 12$$', NULL, 'A solution to the given system of equations is $(x, y)$, where $x > 0$. What is the value of $x$ ?', NULL, NULL, '6', '["6"]'::jsonb, NULL, 37)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 20, '3-20', 20, 'grid', '(Figure: A right triangle. The right angle is at the bottom-left vertex. The vertical left leg has length 11. The hypotenuse, going from the top vertex down to the bottom-right vertex, has length 28. The angle x° is marked at the top vertex (between the vertical leg of length 11 and the hypotenuse of length 28). Note: Figure not drawn to scale.)', 'A right triangle. The right angle is at the bottom-left vertex. The vertical left leg has length 11. The hypotenuse, going from the top vertex down to the bottom-right vertex, has length 28. The angle x° is marked at the top vertex (between the vertical leg of length 11 and the hypotenuse of length 28). Note: Figure not drawn to scale.', 'In the triangle shown, what is the value of $\cos x°$ ?', NULL, NULL, '.3928', '[".3928",".3929","11/28"]'::jsonb, NULL, 39)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
$\text{II. } g(x) = -3(6)^x$', '{"A":"I only","B":"II only","C":"I and II","D":"Neither I nor II"}'::jsonb, NULL, 'D', NULL, NULL, 40)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 2, '4-2', 2, 'mcq', 'Argon is placed inside a container with a constant volume. The graph shows the estimated pressure $y$, in pounds per square inch (psi), of the argon when its temperature is $x$ kelvins.

(Figure: Line graph in the xy-plane. The horizontal axis is labeled "Temperature (kelvins)" with gridlines at 100, 200, 300, 400, 500, 600, 700, and 800. The vertical axis is labeled $y$ with marked values 6, 12, 18, 24, 30, and 36 (pressure in psi). A straight line rises from near the origin, passing through approximately (100, 6) and (200, 12), increasing steadily so that at $x = 600$ the line is at $y = 36$.)', 'Line graph in the xy-plane. The horizontal axis is labeled "Temperature (kelvins)" with gridlines at 100, 200, 300, 400, 500, 600, 700, and 800. The vertical axis is labeled $y$ with marked values 6, 12, 18, 24, 30, and 36 (pressure in psi). A straight line rises from near the origin, passing through approximately (100, 6) and (200, 12), increasing steadily so that at $x = 600$ the line is at $y = 36$.', 'What is the estimated pressure of the argon, in psi, when the temperature is 600 kelvins?', '{"A":"6","B":"12","C":"300","D":"600"}'::jsonb, NULL, 'B', NULL, NULL, 44)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
(Figure: Curve in the xy-plane. The horizontal axis is labeled "Time (seconds)" with gridlines at 1, 2, and 3; the vertical axis is labeled "Height (meters)" with $y$ marked at 3, 6, 9, and 12. The curve starts at about (0, 10), rises slightly to a maximum near 10 meters at about $x = 0.2$, then curves downward and decreases, crossing the x-axis (height 0) at about $x = 1.6$ seconds.)', 'Curve in the xy-plane. The horizontal axis is labeled "Time (seconds)" with gridlines at 1, 2, and 3; the vertical axis is labeled "Height (meters)" with $y$ marked at 3, 6, 9, and 12. The curve starts at about (0, 10), rises slightly to a maximum near 10 meters at about $x = 0.2$, then curves downward and decreases, crossing the x-axis (height 0) at about $x = 1.6$ seconds.', 'What is the best interpretation of the $x$-intercept of the graph?', '{"A":"The diver reaches a maximum height above the water at 1.6 seconds.","B":"The diver hits the water at 1.6 seconds.","C":"The diver reaches a maximum height above the water at 0.2 seconds.","D":"The diver hits the water at 0.2 seconds."}'::jsonb, NULL, 'B', NULL, NULL, 45)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 11, '4-11', 11, 'mcq', 'The scatterplot shows the relationship between two variables $x$ and $y$. A line of best fit for the data is also shown.

(Figure: Scatterplot in the first quadrant. Both axes range from about 1 to 10, with the vertical axis labeled $y$ and the horizontal axis labeled $x$. Ten data points are plotted in a generally increasing pattern, and a straight upward-sloping line of best fit passes through the cluster of points. Some points lie above the line and some below it; the question asks how many points lie above the line of best fit.)', 'Scatterplot in the first quadrant. Both axes range from about 1 to 10, with the vertical axis labeled $y$ and the horizontal axis labeled $x$. Ten data points are plotted in a generally increasing pattern, and a straight upward-sloping line of best fit passes through the cluster of points. Some points lie above the line and some below it; the question asks how many points lie above the line of best fit.', 'For how many of the 10 data points is the actual $y$-value greater than the $y$-value predicted by the line of best fit?', '{"A":"3","B":"4","C":"6","D":"7"}'::jsonb, NULL, 'C', NULL, NULL, 46)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 15, '4-15', 15, 'mcq', 'Five Eretmochelys imbricata, a type of sea turtle, each have a nest. The table shows an original data set of the number of eggs that each turtle laid in its nest. The table has columns "Nest" and "Number of eggs" with rows: A, 149; B, 144; C, 148; D, 136; E, 139.', NULL, 'A sixth nest with 121 eggs is added to create a new data set. Which of the following correctly compares the means of the two data sets?', '{"A":"The mean of the original data set is greater than the mean of the new data set.","B":"The mean of the original data set is less than the mean of the new data set.","C":"The means of both data sets are equal.","D":"There is not enough information to compare the means."}'::jsonb, NULL, 'A', NULL, NULL, 47)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
