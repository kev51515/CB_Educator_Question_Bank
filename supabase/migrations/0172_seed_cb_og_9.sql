...
(Figure: Bar graph titled "Metal Content of Plants with and without Kanamycin Exposure." Y-axis: Metal content (parts per million), 0 to 700. X-axis: Experimental condition (without kanamycin, with kanamycin). Bars show iron and zinc levels for each condition (legend: zinc, iron).)', 'Bar graph titled "Metal Content of Plants with and without Kanamycin Exposure." Y-axis: Metal content (parts per million), 0 to 700. X-axis: Experimental condition (without kanamycin, with kanamycin). Bars show iron and zinc levels for each condition (legend: zinc, iron).', 'Which choice best describes data in the graph that support Ayalew and her colleagues'' hypothesis?', '{"A":"The control plants contained higher levels of zinc than iron, but plants exposed to kanamycin contained higher levels of iron than zinc.","B":"Both groups of plants contained more than 200 parts per million of both iron and zinc.","C":"Zinc levels were around 300 parts per million in the control plants but nearly 400 parts per million in the plants exposed to kanamycin.","D":"The plants exposed to kanamycin showed lower levels of iron and zinc than the control plants did."}'::jsonb, NULL, 'D', NULL, NULL, 8)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
The solution to the given system of equations is $(x, y)$. What is the value of $y$ ?', '{"A":"$-3$","B":"6","C":"18","D":"30"}'::jsonb, NULL, 'B', NULL, NULL, 40)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 6, '4-6', 6, 'grid', '(Figure: A transversal line $c$ crosses two parallel horizontal lines, the upper line labeled $s$ and the lower line labeled $t$. At the intersection of $c$ with line $s$, the angle on the upper-left side is labeled $x°$. At the intersection of $c$ with line $t$, an angle of $110°$ is marked. Figure not drawn to scale.)', 'A transversal line $c$ crosses two parallel horizontal lines, the upper line labeled $s$ and the lower line labeled $t$. At the intersection of $c$ with line $s$, the angle on the upper-left side is labeled $x°$. At the intersection of $c$ with line $t$, an angle of $110°$ is marked. Figure not drawn to scale.', 'In the figure shown, line $c$ intersects parallel lines $s$ and $t$. What is the value of $x$ ?

Note: Figure not drawn to scale.', NULL, NULL, '70', '["70"]'::jsonb, NULL, 41)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
What is one of the solutions to the given equation?', NULL, NULL, '2', '["2","-12"]'::jsonb, NULL, 43)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 17, '4-17', 17, 'mcq', 'Two dot plots represent the number of glue sticks brought in by each student for two classes. Class A: values range across 1 to 7 on its number line. Class B: values range across 14 to 20 on its number line.

(Figure: Two dot plots side by side, each plotting number of glue sticks. Class A is plotted over a number line marked 1 2 3 4 5 6 7, with dots clustered in the middle of that range. Class B is plotted over a number line marked 14 15 16 17 18 19 20, with dots clustered in the middle of that range. Both distributions have a similar shape/spread about their respective centers.)', 'Two dot plots side by side, each plotting number of glue sticks. Class A is plotted over a number line marked 1 2 3 4 5 6 7, with dots clustered in the middle of that range. Class B is plotted over a number line marked 14 15 16 17 18 19 20, with dots clustered in the middle of that range. Both distributions have a similar shape/spread about their respective centers.', 'Each of the dot plots shown represents the number of glue sticks brought in by each student for two classes, class A and class B. Which statement best compares the standard deviations of the numbers of glue sticks brought in by each student for these two classes?', '{"A":"The standard deviation of the number of glue sticks brought in by each student for class A is less than the standard deviation of the number of glue sticks brought in by each student for class B.","B":"The standard deviation of the number of glue sticks brought in by each student for class A is equal to the standard deviation of the number of glue sticks brought in by each student for class B.","C":"The standard deviation of the number of glue sticks brought in by each student for class A is greater than the standard deviation of the number of glue sticks brought in by each student for class B.","D":"There is not enough information to compare these standard deviations."}'::jsonb, NULL, 'B', NULL, NULL, 43)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
