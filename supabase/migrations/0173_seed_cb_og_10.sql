...
Past studies of white dwarf atmospheres have concluded that certain exoplanets had continental crusts. Geologist Keith Putirka and astronomer Siyi Xu argue that those studies unduly emphasize atmospheric traces of lithium and other individual elements as signifiers of the types of rock found on Earth. The studies don''t adequately account for different minerals made up of various ratios of those elements, and the possibility of rock types not found on Earth that contain those minerals.', NULL, 'Based on the texts, how would Putirka and Xu (Text 2) most likely characterize the conclusion presented in Text 1?', '{"A":"As unexpected, because it was widely believed at the time that white dwarf exoplanets lack continental crusts","B":"As premature, because researchers have only just begun trying to determine what kinds of crusts white dwarf exoplanets had","C":"As questionable, because it rests on an incomplete consideration of potential sources of the elements detected in white dwarf atmospheres","D":"As puzzling, because it''s unusual to successfully detect lithium and sodium when analyzing wavelengths of light in white dwarf atmospheres"}'::jsonb, NULL, 'C', NULL, NULL, 5)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 11, '1-11', 11, 'mcq', 'The following text is from David Barclay Moore''s 2022 novel <i>Holler of the Fireflies</i>. The narrator has just arrived at summer camp, which is far away from his home.

This place was different than I thought it would be. I''d never been somewhere like this before. I did feel scared, but also excited.', NULL, 'According to the text, how does the narrator feel about being at summer camp?', '{"A":"He feels overjoyed.","B":"He feels peaceful.","C":"He feels both scared and excited.","D":"He feels both angry and jealous."}'::jsonb, NULL, 'C', NULL, NULL, 6)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 12, '1-12', 12, 'mcq', 'The following text is adapted from Oscar Wilde''s 1891 novel <i>The Picture of Dorian Gray</i>. Dorian Gray is taking his first look at a portrait that Hallward has painted of him.
...
Which finding, if true, would most strongly support the team''s conclusion?', '{"A":"Analysis of the animal bones showed that the cattle''s diet also consisted of wheat, which humans widely cultivated in China during the Bronze Age.","B":"Further investigation of sheep and goat bones revealed that their diets consisted of small portions of millet as well.","C":"Cattle''s diets generally require larger amounts of food and a greater variety of nutrients than do sheep''s and goats'' diets.","D":"The diets of sheep, goats, and cattle were found to vary based on what the farmers in each Bronze Age settlement could grow."}'::jsonb, NULL, 'A', NULL, NULL, 8)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 17, '1-17', 17, 'mcq', NULL, 'Line graph titled "Average Survival of Fruit Flies following Infection." X-axis: "Days after infection" (0, 2, 6, 10, 14). Y-axis: "Survival rate (% alive)" (0 to 110 by 10s). Three series: type A flies (solid line, filled triangles) stays high, declining from 100% to about 90% by day 14; type AB flies (dashed line, open squares) drops from 100% to about 45% at day 6, about 11% at day 10, near 0% at day 14; type B flies (dotted line, open circles) drops from 100% to about 41% at day 6, near 0% by day 10–14.', 'In a study of the evolution of <i>DptA</i> and <i>DptB</i>—<i>Diptericin</i> genes encoding antimicrobial peptides that combat pathogens and foster beneficial microbes in fruit flies (<i>Drosophila</i>)—researchers assessed <i><i>Drosophila</i> melanogaster</i> resistance to pathogenic infections by <i>Providencia rettgeri</i> and <i>Acetobacter sicerae</i>, bacteria common in the flies'' environments. Subjects included flies identified by mutations silencing <i>DptA</i>, <i>DptB</i>, or both <i>DptA</i> and <i>DptB</i> (termed types A, B, and AB, respectively). In conjunction with the observation that resistance to <i>P. rettgeri</i> correlates with <i>DptA</i> activity but is not significantly affected by <i>DptB</i> activity, data in the graph of survival rates post–<i>A. sicerae</i> infection suggest that ______

Which completion of the text is best supported by data in the graph?', '{"A":"<i>DptA</i> confers defense against <i>A. sicerae</i> regardless of the presence of <i>DptB</i>.","B":"<i>DptB</i> protects against only one bacteria species, whereas <i>DptA</i> protects against multiple species.","C":"<i>DptB</i> may have developed as a specific defense against <i>A. sicerae</i>.","D":"defense against <i>A. sicerae</i> is strongest when both <i>DptA</i> and <i>DptB</i> are present."}'::jsonb, '/data/tests/cb-og-10/figures/m1-q17.png', 'C', NULL, NULL, 9)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 18, '1-18', 18, 'mcq', NULL, NULL, '<i>Euphorbia esula</i> (leafy spurge) is a Eurasian plant that has become invasive in North America, where it displaces native vegetation and sickens cattle. <i>E. esula</i> can be controlled with chemical herbicides, but that approach can also kill harmless plants nearby. Recent research on introducing engineered DNA into plant species to inhibit their reproduction may offer a path toward exclusively targeting <i>E. esula</i>, consequently ______

Which choice most logically completes the text?', '{"A":"making individual <i>E. esula</i> plants more susceptible to existing chemical herbicides.","B":"enhancing the ecological benefits of <i>E. esula</i> in North America.","C":"enabling cattle to consume <i>E. esula</i> without becoming sick.","D":"reducing invasive <i>E. esula</i> numbers without harming other organisms."}'::jsonb, NULL, 'D', NULL, NULL, 10)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
Which choice completes the text so that it conforms to the conventions of Standard English?', '{"A":"lifelike but","B":"lifelike","C":"lifelike,","D":"lifelike, but"}'::jsonb, NULL, 'C', NULL, NULL, 11)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 24, '1-24', 24, 'mcq', NULL, NULL, 'Food and the sensation of taste are central to Monique Truong''s novels. In <i>The Book of Salt</i>, for example, the exiled character of Bình connects to his native Saigon through the food he prepares, while in <i>Bitter in the Mouth</i>, the character of Linda ______ a form of synesthesia whereby the words she hears evoke tastes.
...
Which choice completes the text so that it conforms to the conventions of Standard English?', '{"A":"photosynthesis and","B":"photosynthesis,","C":"photosynthesis:","D":"photosynthesis"}'::jsonb, NULL, 'C', NULL, NULL, 12)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 26, '1-26', 26, 'mcq', NULL, NULL, 'In Marisol''s 1968 sculpture <i>Mi Mama y Yo</i>, gone are the types of pop culture references that made the Parisian-born Venezuelan American artist a star at the height of the pop art movement. In ______ place is a far more personal subject: a sculptural depiction of the artist as a young girl with her mother.
...
Which choice completes the text so that it conforms to the conventions of Standard English?', '{"A":"is","B":"were","C":"have been","D":"are"}'::jsonb, NULL, 'A', NULL, NULL, 12)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 28, '1-28', 28, 'mcq', NULL, NULL, 'Organisms have evolved a number of surprising adaptations to ensure their survival in adverse conditions. Tadpole shrimp (<i>Triops longicaudatus</i>) embryos, ______ can pause development for over ten years during extended periods of drought.
...
Which choice completes the text with the most logical transition?', '{"A":"in contrast,","B":"for example,","C":"meanwhile,","D":"consequently,"}'::jsonb, NULL, 'B', NULL, NULL, 12)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 29, '1-29', 29, 'mcq', NULL, NULL, 'When Chinese director Chloé Zhao accepted the Oscar in 2021 for her film <i>Nomadland</i>, she made Academy Award history. ______ only one other woman, Kathryn Bigelow of the United States, had been named best director at the Oscars, making Zhao the second woman and the first Asian woman to win the award.
...
• She founded the Gullah Museum of Georgetown, South Carolina, in 2003.', NULL, 'The student wants to emphasize the duration and purpose of Cohen''s and Rodrigues''s work. Which choice most effectively uses relevant information from the notes to accomplish this goal?', '{"A":"At the Gullah Museums in Hilton Head Island and Georgetown, South Carolina, visitors can learn more about the Gullah people who have lived in the region for centuries.","B":"Louise Miller Cohen and Vermelle Rodrigues have worked to preserve the culture of the Gullah people, who have lived in the United States since the 18th century.","C":"Since 2003, Louise Miller Cohen and Vermelle Rodrigues have worked to preserve Gullah culture through their museums.","D":"Influenced by the traditions of West and Central Africa, Gullah culture developed in parts of the southeastern United States in the 18th century."}'::jsonb, NULL, 'C', NULL, NULL, 14)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 6, '2-6', 6, 'mcq', 'The following text is adapted from Pam Muñoz Ryan''s 2020 novel <i>Mañanaland</i>. In the village where Max lives, there is an old fortress called La Reina. Children in the village say that the fortress is haunted.
...
For as long as he could remember, Max had begged Papá [his father] to take him to see La Reina and the ruins up close. He''d be a hero among his friends if he was the first boy to cross the haunted gates! Just because Papá didn''t believe in ghosts didn''t mean they weren''t there. Maybe this summer Papá would finally take him. He was almost twelve.', NULL, 'Which choice best describes the overall purpose of the text?', '{"A":"To portray how proud Max''s father is of Max","B":"To explain why Max doesn''t want to grow up yet","C":"To criticize Max for disliking summer","D":"To show how much Max wants to visit La Reina"}'::jsonb, NULL, 'D', NULL, NULL, 20)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 7, '2-7', 7, 'mcq', 'The following text is adapted from George Bernard Shaw''s 1912 play <i>Pygmalion</i>. Henry Higgins has just arrived at the house of his mother (Mrs. Higgins). She is expecting her friends to visit soon.
...
<u>Exultant leap upon the rugged rocks;
...
Leap joyous as it own bright, singing waves!', NULL, 'Which choice best describes the function of the underlined portion in the text as a whole?', '{"A":"It portrays the surroundings as an imposing and intimidating scene.","B":"It characterizes the sea''s waves as a relentless and enduring force.","C":"It conveys the speaker''s ambivalence about the natural world.","D":"It draws a contrast between the sea''s waves and the speaker''s thoughts."}'::jsonb, NULL, 'B', NULL, NULL, 21)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 10, '2-10', 10, 'mcq', 'The following text is adapted from Lewis Carroll''s 1889 satirical novel <i>Sylvie and Bruno</i>. A crowd has gathered outside a room belonging to the Warden, an official who reports to the Lord Chancellor.
...
Global biomass is the total mass of living material, such as animals and plants, on Earth. A team of scientists estimated the global biomass, by species, of various wild land mammals. The team found that the species with the highest global biomass is the ______', 'Bar graph titled "Top Four Species of Wild Land Mammals by Global Biomass." Vertical axis: Global biomass (millions of tonnes), scaled 0 to 3.0. Horizontal axis lists four species: African bush elephant, eastern gray kangaroo, wild boar, and white-tailed deer.', 'Which choice most effectively uses data from the graph to complete the sentence?', '{"A":"wild boar.","B":"eastern gray kangaroo.","C":"African bush elephant.","D":"white-tailed deer."}'::jsonb, '/data/tests/cb-og-10/figures/m2-q11.png', 'D', NULL, NULL, 22)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
Over the past two hundred years, the percentage of the population employed in the agricultural sector has declined in both France and the United States, while employment in the service sector (which includes jobs in retail, consulting, real estate, etc.) has risen. However, this transition happened at very different rates in the two countries. This can be seen most clearly by comparing the employment by sector in both countries in ______', NULL, 'Which choice most effectively uses data from the table to complete the statement?', '{"A":"1900 with the employment by sector in 1950.","B":"1800 with the employment by sector in 2012.","C":"1900 with the employment by sector in 2012.","D":"1800 with the employment by sector in 1900."}'::jsonb, NULL, 'A', NULL, NULL, 25)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 21, '2-21', 21, 'mcq', 'In his 1963 exhibition <i>Exposition of Music—</i><i>Electronic Television</i>, Korean American artist Nam June Paik showed how television images could be manipulated to express an artist''s perspective. Today, Paik ______ considered the first video artist.', NULL, 'Which choice completes the text so that it conforms to the conventions of Standard English?', '{"A":"will be","B":"had been","C":"was","D":"is"}'::jsonb, NULL, 'D', NULL, NULL, 27)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
• In 1851, German American artist Emanuel Leutze painted <i>Washington Crossing the Delaware</i>.
• His huge painting (149 × 255 inches) depicts the first US president crossing a river with soldiers in the Revolutionary War.
• In 2019, Cree artist Kent Monkman painted mistikôsiwak (Wooden Boat People): Resurgence of <i>the People</i>.
...
The student wants to emphasize a similarity between the two paintings.', NULL, 'Which choice most effectively uses relevant information from the notes to accomplish this goal?', '{"A":"Monkman, a Cree artist, finished his painting in 2019; Leutze, a German American artist, completed his in 1851.","B":"Although Monkman''s painting was inspired by Leutze''s, the people and actions the two paintings portray are very different.","C":"Leutze''s and Monkman''s paintings are both huge, measuring 149 × 255 inches and 132 × 264 inches, respectively.","D":"Leutze''s painting depicts Revolutionary War soldiers, while Monkman''s depicts Indigenous people and refugees."}'::jsonb, NULL, 'C', NULL, NULL, 31)
  ...
  RETURNING id INTO v_mod;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 1, '3-1', 1, 'mcq', 'The line graph shows the percent of cars for sale at a used car lot on a given day by model year.', 'Line graph titled with x-axis "Model year" (labeled 2010 through 2019) and y-axis "Percent of cars for sale" (0% to 15%). The plotted points: 2010 ≈ 12%, 2011 ≈ 12%, 2012 ≈ 12%, 2013 ≈ 8%, 2014 ≈ 4%, 2015 ≈ 9%, 2016 ≈ 10%, 2017 ≈ 10%, 2018 ≈ 11%, 2019 ≈ 11%. The lowest point is at 2014.', 'For what model year is the percent of cars for sale the smallest?', '{"A":"2012","B":"2013","C":"2014","D":"2015"}'::jsonb, '/data/tests/cb-og-10/figures/m3-q1.png', 'C', NULL, NULL, 32)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 2, '3-2', 2, 'mcq', NULL, 'An xy-coordinate plane with x-axis from -6 to 6 and y-axis from -6 to 6. Two straight lines are drawn. The lines intersect at the point (4, -5) in the fourth quadrant.', 'The graph of a system of linear equations is shown. What is the solution $(x, y)$ to the system?', '{"A":"$(4, -5)$","B":"$(0, 3)$","C":"$(0, -2)$","D":"$(-2, 3)$"}'::jsonb, '/data/tests/cb-og-10/figures/m3-q2.png', 'A', NULL, NULL, 32)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 4, '3-4', 4, 'mcq', NULL, 'The given graph is an upward-opening parabola in an xy-plane (x-axis from -6 to 10, y-axis from -8 to 4) with vertex at approximately (2, -2), passing through the y-axis near y = 4. The four answer choices A-D are each graphs of upward-opening parabolas on identical grids; the correct one is the original parabola shifted up 4 units (vertex near (2, 2)).', 'The graph shown will be translated up 4 units. Which of the following will be the resulting graph?', '{"A":"A parabola opening upward with vertex at approximately (2, 2), passing through the y-axis near y = 5.","B":"A parabola opening upward with vertex at approximately (2, -6).","C":"A parabola opening upward with vertex at approximately (-2, -2).","D":"A parabola opening upward with vertex at approximately (6, -2)."}'::jsonb, '/data/tests/cb-og-10/figures/m3-q4.png', 'A', NULL, NULL, 34)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
What is the sum of the solutions to the given equation?', NULL, NULL, '29/3', '["29/3","9.666","9.667"]'::jsonb, NULL, 40)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 2, '4-2', 2, 'mcq', 'The scatterplot shows the relationship between two variables, $x$ and $y$. A line of best fit is also shown.', 'A scatterplot in the xy-plane. The x-axis is labeled x and runs from 0 to about 14 (gridlines at 2, 4, 6, 8, 10, 12, 14); the y-axis is labeled y and runs from 0 to 20 (gridlines at 2, 4, 6, ..., 20). Five data points rise from lower left to upper right at approximately (4, 6), (6, 10), (8, 11), (10, 13.5), and (12, 15), with a sixth near (13, 16). A straight line of best fit is drawn through them, crossing the y-axis near 3.4 and increasing with a slope of about 1.', 'Which of the following equations best represents the line of best fit shown?', '{"A":"$y = x + 3.4$","B":"$y = x - 3.4$","C":"$y = -x + 3.4$","D":"$y = -x - 3.4$"}'::jsonb, '/data/tests/cb-og-10/figures/m4-q2.png', 'A', NULL, NULL, 46)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 3, '4-3', 3, 'mcq', 'The graph shows the linear relationship between $x$ and $y$.', 'A line graph in the xy-plane. The x-axis runs from -8 to 8 and the y-axis from -6 to 10. A straight line slopes upward from lower left to upper right, passing through approximately (0, -5) on the y-axis and (2.5, 0) on the x-axis, with a slope of about 2.', 'Which table gives three values of $x$ and their corresponding values of $y$ for this relationship?', '{"A":"x: 0, 1, 2 with y: 0, -7, -9","B":"x: 0, 1, 2 with y: 0, -3, -1","C":"x: 0, 1, 2 with y: -5, -7, -9","D":"x: 0, 1, 2 with y: -5, -3, -1"}'::jsonb, '/data/tests/cb-og-10/figures/m4-q3.png', 'D', NULL, NULL, 46)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
$y = x^2 - 5$', NULL, 'The graphs of the given equations in the xy-plane intersect at the point $(x, y)$. What is a possible value of $x$?', '{"A":"$-\\dfrac{76}{5}$","B":"$-9$","C":"$5$","D":"$76$"}'::jsonb, NULL, 'B', NULL, NULL, 48)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 16, '4-16', 16, 'mcq', 'The graph shows the relationship between the number of shares of stock from Company A, $x$, and the number of shares of stock from Company B, $y$, that Simone can purchase.', 'A line graph in the first quadrant. The horizontal axis is labeled Company A (x) and runs from 0 to 100 (gridlines every 10); the vertical axis is labeled Company B (y) and runs from 0 to 50 (gridlines every 10). A straight line decreases from the y-intercept at (0, 40) down to the x-intercept at (60, 0).', 'Which equation could represent this relationship?', '{"A":"$y = 8x + 12$","B":"$8x + 12y = 480$","C":"$y = 12x + 8$","D":"$12x + 8y = 480$"}'::jsonb, '/data/tests/cb-og-10/figures/m4-q16.png', 'B', NULL, NULL, 49)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 26, '4-26', 26, 'mcq', 'Two data sets of 23 integers each are summarized in the histograms shown. For each of the histograms, the first interval represents the frequency of integers greater than or equal to 10, but less than 20. The second interval represents the frequency of integers greater than or equal to 20, but less than 30, and so on.', 'Two histograms side by side, each with a vertical axis labeled Frequency (0 to 12) and a horizontal axis labeled Integer with bin boundaries at 10, 20, 30, 40, 50, 60. Data Set A: bars over the intervals starting at 10, 20, 30, 40 with frequencies of approximately 3, 4, 7, and 9 (rising left to right). Data Set B: bars over the same intervals with the same approximate frequencies of 3, 4, 7, and 9.', 'What is the smallest possible difference between the mean of data set A and the mean of data set B?', '{"A":"0","B":"1","C":"10","D":"23"}'::jsonb, '/data/tests/cb-og-10/figures/m4-q26.png', 'B', NULL, NULL, 52)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
