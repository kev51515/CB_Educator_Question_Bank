...
The multitude of Paris seems to be dressed in blue every day but Sunday, when, for the most part, they put on an unbelievably festive black. Here they were now, in blue, disputing, every inch, our passage, with their wagons, handtrucks, their bursting baskets carried at an angle steeply self-confident on the back.', NULL, 'As used in the text, what does the word "disputing" most nearly mean?', '{"A":"Arguing about","B":"Disapproving of","C":"Asserting possession of","D":"Providing resistance to"}'::jsonb, NULL, 'D', NULL, NULL, 5)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 8, '1-8', 8, 'mcq', 'The following text is adapted from Herman Melville''s 1855 novel <i>Israel Potter</i>. Israel is a young man wandering through New England during the late eighteenth century.
...
In 1954 George Balanchine choreographed a production of <i>The <i>Nutcracker</i></i>, a ballet by Pyotr Ilyich Tchaikovsky. It has since become a tradition for hundreds of dance companies in North America to stage <i>The <i>Nutcracker</i></i> each year. But the show is stuck in the past, with an old-fashioned story and references, so <u>it should no longer be produced</u>. Ballet needs to create new traditions if it wants to stay relevant to contemporary audiences.

Text 2
<i>The <i>Nutcracker</i></i> is outdated, but it should be kept because it''s a holiday favorite and provides substantial income for some dance companies. Although it can be behind the times, there are creative ways to update the show. For example, Debbie Allen successfully modernized the story. Her show <i>Hot Chocolate <i>Nutcracker</i></i> combines ballet, tap, hip-hop, and other styles, and it has been gaining in popularity since it opened in 2009.', NULL, 'Based on the texts, how would the author of Text 2 most likely respond to the underlined claim in Text 1?', '{"A":"By questioning the idea that the story of <i>The <i>Nutcracker</i></i> is stuck in the past and by rejecting the suggestion that contemporary audiences would enjoy an updated version","B":"By agreeing that contemporary audiences have largely stopped going to see performances of <i>The <i>Nutcracker</i></i> because it''s so old-fashioned","C":"By pointing out that most dance companies could increase their incomes by offering modernized versions of <i>The <i>Nutcracker</i></i>","D":"By suggesting that dance companies should consider offering revised versions of <i>The <i>Nutcracker</i></i> instead of completely rejecting the show"}'::jsonb, NULL, 'D', NULL, NULL, 7)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
A student is using the table as part of a social studies class presentation on the US auto industry in the early twentieth century. The student notes that, according to the table, from 1910 to 1925 ______', NULL, 'Which choice most effectively uses data from the table to complete the statement?', '{"A":"the number of cars produced increased but the number of companies producing cars decreased.","B":"both the number of cars produced and the number of companies producing cars remained unchanged.","C":"the number of cars produced decreased but the number of companies producing cars remained unchanged.","D":"both the number of cars produced and the number of companies producing cars increased."}'::jsonb, NULL, 'A', NULL, NULL, 8)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 13, '1-13', 13, 'mcq', 'The 2021 exhibition <i>This Is the Day</i> at Arkansas''s Crystal Bridges Museum of American Art featured works dealing with expressions of faith and spirituality in the Black community. The museum''s 2022 exhibition <i><i>The Dirty South</i></i>, meanwhile, focused on Black culture in the American South from 1920 to 2020, with a particular focus on the intersections between visual arts and music. Together, these exhibitions don''t merely highlight the diversity of the Black experience in the US; <u>they also showcase the diverse media through which artists have depicted and engaged with that experience</u>.', NULL, 'Which statement about the exhibitions, if true, would most directly support the underlined claim?', '{"A":"Between them, <i>This Is the Day</i> and <i><i>The Dirty South</i></i> included drawings, paintings, photographs, sculptures, textiles, videos, costumes, and music.","B":"<i>This Is the Day</i> included works by fewer than two dozen artists, whereas <i><i>The Dirty South</i></i> included works by more than 80 artists.","C":"<i>This Is the Day</i> exclusively included works in the permanent collection of the museum, whereas <i><i>The Dirty South</i></i> included works from multiple sources outside the museum.","D":"Between them, <i>This Is the Day</i> and <i><i>The Dirty South</i></i> included works depicting more than 300 years of Black experience in the United States."}'::jsonb, NULL, 'A', NULL, NULL, 9)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
The student wants to emphasize a similarity between the two sculptures. Which choice most effectively uses relevant information from the notes to accomplish this goal?', NULL, 'Which choice most effectively uses relevant information from the notes to accomplish this goal?', '{"A":"Catlett''s <i>Students Aspire</i> depicts two figures supporting each other in the pursuit of equality.","B":"<i>Recognition</i> and <i>Students Aspire</i> both show African American figures in poses that symbolize supportive relationships.","C":"Catlett completed <i>Recognition</i> in 1970 and <i>Students Aspire</i> in 1978.","D":"The figures in <i>Recognition</i> have features that are rounded and indistinct, while the figures in <i>Students Aspire</i> have sharply defined features."}'::jsonb, NULL, 'B', NULL, NULL, 17)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
The student wants to make a generalization about the materials used in dhow replicas. Which choice most effectively uses relevant information from the notes to accomplish this goal?', NULL, 'Which choice most effectively uses relevant information from the notes to accomplish this goal?', '{"A":"A traditional material that was used to stitch together the hulls of ancient dhows, coconut palm fiber rope is still used by shipbuilders.","B":"The ancient Arab dhow was a sailing vessel used primarily for trade and distinguishable by its triangular sails.","C":"Although most materials used in dhow replicas are traditional, some modern materials are used.","D":"Contemporary shipbuilders in Oman build replicas of the dhow, which was an ancient sailing vessel with a stitched hull construction."}'::jsonb, NULL, 'C', NULL, NULL, 17)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 6, '2-6', 6, 'mcq', 'The following text is from Betty Smith''s 1943 novel <i>A Tree Grows in Brooklyn</i>. Francie, a young girl, visits the library often.
...
To test whether a medication is effective, scientists compare outcomes for patients taking it and patients taking a placebo (a medically inactive substance). Patients normally aren''t told they''re receiving a placebo, but a research team conducted a study to see if there might be a medical benefit to telling them. The team used various measures to evaluate participants, with higher ratings indicating greater well-being in each measure. Compared to the mean ratings after 21 days for participants in the control group, the mean ratings for participants who were aware of taking a placebo ______', NULL, 'Which choice most effectively uses data from the table to complete the statement?', '{"A":"ranged from 5.0 to 92.00, indicating that well-being varied widely from participant to participant.","B":"were lower for two measures, with the rating for only one measure indicating greater well-being for these participants.","C":"ranged from 3.9 to 46.00, with no rating indicating greater well-being in any measure for these participants.","D":"were higher for all three measures, indicating greater overall well-being for these participants."}'::jsonb, NULL, 'D', NULL, NULL, 24)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 29, '2-29', 29, 'mcq', 'Biographer Michael Gorra notes that the novelist Henry James "lived in a world of second thoughts," frequently tinkering with his novels and stories after their initial publication. However, the differences between the 1881 first edition and the 1908 edition of his novel <i>A Portrait of a Lady</i> are extreme, even by James''s standards; ______ some critics regard the two editions as two different novels altogether.', NULL, 'Which choice completes the text with the most logical transition?', '{"A":"by contrast,","B":"in fact,","C":"nevertheless,","D":"in other words,"}'::jsonb, NULL, 'B', NULL, NULL, 28)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
• She collected a sample of <i><i>Polytrichum</i> <i>juniperinum</i></i> from Serra de Itatiaia in Mauá in February of 1925.
• She collected a sample of <i><i>Sphagnum</i> <i>gracilescen</i></i> from Ponte do Inferno in Corcovado in March of 1925.
• <i><i>Polytrichum</i> <i>juniperinum</i></i> and <i><i>Sphagnum</i> <i>gracilescen</i></i> are both species of moss.

The student wants to emphasize the sample collected from Serra de Itatiaia. Which choice most effectively uses relevant information from the notes to accomplish this goal?', NULL, 'Which choice most effectively uses relevant information from the notes to accomplish this goal?', '{"A":"Doña María do Carmo Bandeira was a botanist notable for collecting approximately 800 botanical samples between 1924 and 1941.","B":"Among the many botanical samples Doña María do Carmo Bandeira collected was <i><i>Polytrichum</i> <i>juniperinum</i></i>, a species of moss she collected from Serra de Itatiaia in 1925.","C":"Between 1924 and 1941, Doña María do Carmo Bandeira collected many botanical samples, such as <i><i>Polytrichum</i> <i>juniperinum</i></i> from Serra de Itatiaia and <i><i>Sphagnum</i> <i>gracilescen</i></i> from Ponte do Inferno.","D":"Between 1924 and 1941, Doña María do Carmo Bandeira collected samples of <i><i>Polytrichum</i> <i>juniperinum</i></i> and <i><i>Sphagnum</i> <i>gracilescen</i></i>, both species of moss."}'::jsonb, NULL, 'B', NULL, NULL, 30)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
What is the positive solution to the given equation?', '{"A":"$144$","B":"$72$","C":"$38$","D":"$12$"}'::jsonb, NULL, 'D', NULL, NULL, 36)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 5, '3-5', 5, 'mcq', NULL, 'Graph in the xy-plane. The horizontal axis is labeled "Time (seconds)" with gridlines from 1 to 10; the vertical axis is labeled "Height above ground (meters)" with gridlines at 10, 20, 30, 40, 50, 60. The curve starts above the origin, rises to a maximum height of about 60 meters near x = 3, then decreases, crossing the x-axis near x = 9 (a concave-down parabola-like flight path).', 'An object was launched upward from a platform. The graph shown models the height above ground, $y$, in meters, of the object $x$ seconds after it was launched. For which of the following intervals of time was the height of the object increasing for the entire interval?', '{"A":"From $x = 0$ to $x = 2$","B":"From $x = 0$ to $x = 4$","C":"From $x = 2$ to $x = 3$","D":"From $x = 3$ to $x = 4$"}'::jsonb, '/data/tests/cb-og-6/figures/m3-q5.png', 'A', NULL, NULL, 36)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
For which of the following tables are all the values of $x$ and their corresponding values of $y$ solutions to the given inequality?', '{"A":"Table with $x = 2, 4, 6$ and $y = 19, 30, 41$.","B":"Table with $x = 2, 4, 6$ and $y = 8, 16, 24$.","C":"Table with $x = 2, 4, 6$ and $y = 13, 18, 23$.","D":"Table with $x = 2, 4, 6$ and $y = 13, 21, 29$."}'::jsonb, NULL, 'A', NULL, NULL, 38)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 14, '3-14', 14, 'grid', NULL, 'A right triangle with the right angle at the bottom-left vertex. The vertical leg on the left is labeled 3 and the horizontal leg along the bottom is labeled 5. The hypotenuse runs from the top of the vertical leg down to the right end of the horizontal leg. Note: Figure not drawn to scale.', 'The figure shows the lengths, in inches, of two sides of a right triangle. What is the area of the triangle, in square inches?', NULL, '/data/tests/cb-og-6/figures/m3-q14.png', '7.5', '["7.5","15/2"]'::jsonb, NULL, 38)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 15, '3-15', 15, 'mcq', NULL, 'Graph in the xy-plane. The horizontal x-axis is labeled 1 to 6 and the vertical y-axis is labeled in unit increments from 1 to 13. A smooth concave-down curve begins at about (0, 5), rises through the points, and levels off near a maximum of about 13 around x = 4 to 5.', 'The graph models the number of active projects a company was working on $x$ months after the end of November 2012, where $0 \le x \le 6$. According to the model, what is the predicted number of active projects the company was working on at the end of November 2012?', '{"A":"$0$","B":"$5$","C":"$8$","D":"$9$"}'::jsonb, '/data/tests/cb-og-6/figures/m3-q15.png', 'B', NULL, NULL, 39)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
Which of the following could be the median number of employees for the restaurants in this town?', '{"A":"$2$","B":"$9$","C":"$15$","D":"$21$"}'::jsonb, NULL, 'D', NULL, NULL, 40)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 21, '3-21', 21, 'grid', NULL, 'Graph in the xy-plane with x-axis labeled -6, -4, -2, 2, 4 and y-axis labeled 4, 2, -2, -4, -6, -8, -10, origin O. An upward-opening parabola has its vertex near (-1.5, -8) and passes through the points (-2, -6) and (0, -6); it crosses the x-axis near x = -3.5 and x = 0.5.', 'The graph of $y = 2x^2 + bx + c$ is shown, where $b$ and $c$ are constants. What is the value of $bc$?', NULL, '/data/tests/cb-og-6/figures/m3-q21.png', '-24', '["-24"]'::jsonb, NULL, 40)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 23, '3-23', 23, 'mcq', NULL, 'Graph in the xy-plane with x-axis labeled -6, -4, -2, 2 and y-axis labeled -6, -4, -2, 2, 4, 6, origin O. Circle A is drawn centered at (-2, 0) with radius 3 (a dot marks the center).', 'Circle $A$ (shown) is defined by the equation $(x + 2)^2 + y^2 = 9$. Circle $B$ (not shown) is the result of shifting circle $A$ down 6 units and increasing the radius so that the radius of circle $B$ is 2 times the radius of circle $A$. Which equation defines circle $B$?', '{"A":"$(x + 2)^2 + (y + 6)^2 = (4)(9)$","B":"$2(x + 2)^2 + 2(y + 6)^2 = 9$","C":"$(x + 2)^2 + (y - 6)^2 = (4)(9)$","D":"$2(x + 2)^2 + 2(y - 6)^2 = 9$"}'::jsonb, '/data/tests/cb-og-6/figures/m3-q23.png', 'A', NULL, NULL, 41)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 24, '3-24', 24, 'mcq', NULL, 'Right triangle ABC with the right angle at vertex C (bottom-left). Vertex A is at the top-left, vertex B at the bottom-right. The hypotenuse AB is labeled 54, and the angle at B is labeled 30 degrees. Note: Figure not drawn to scale.', 'Right triangle $ABC$ is shown. What is the value of $\tan A$?', '{"A":"$\\dfrac{\\sqrt{3}}{54}$","B":"$\\dfrac{1}{\\sqrt{3}}$","C":"$\\sqrt{3}$","D":"$27\\sqrt{3}$"}'::jsonb, '/data/tests/cb-og-6/figures/m3-q24.png', 'C', NULL, NULL, 41)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  ...
  RETURNING id INTO v_mod;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 1, '4-1', 1, 'mcq', NULL, NULL, 'The function $f$ is defined by $f(x) = 8x$. For what value of $x$ does $f(x) = 72$?', '{"A":"8","B":"9","C":"64","D":"80"}'::jsonb, NULL, 'B', NULL, NULL, 44)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 2, '4-2', 2, 'mcq', 'Note: Figure not drawn to scale.', 'Two straight lines cross at a single point, forming an X. Angle 1 and angle 2 are the pair of vertical (opposite) angles formed at the intersection.', 'In the figure, two lines intersect at a point. Angle 1 and angle 2 are vertical angles. The measure of angle 1 is $72°$. What is the measure of angle 2?', '{"A":"$72°$","B":"$108°$","C":"$144°$","D":"$288°$"}'::jsonb, '/data/tests/cb-og-6/figures/m4-q2.png', 'A', NULL, NULL, 44)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 4, '4-4', 4, 'mcq', NULL, 'An xy-coordinate plane with gridlines, x-axis from about -10 to 10 and y-axis from about -10 to 10. A single straight line is graphed that falls from upper-left to lower-right, crossing the axes (a line with negative slope).', 'The graph of function $f$ is shown, where $y = f(x)$. Which of the following describes function $f$?', '{"A":"Increasing linear","B":"Decreasing linear","C":"Increasing exponential","D":"Decreasing exponential"}'::jsonb, '/data/tests/cb-og-6/figures/m4-q4.png', 'A', NULL, NULL, 44)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 5, '4-5', 5, 'mcq', NULL, 'An xy-coordinate plane with origin O. The x-axis is marked at 2 and 4; the y-axis is marked at -2, -4, -6, -8. A straight line with positive slope rises from lower-left to upper-right, crossing the y-axis below the origin (between 0 and -4) and crossing the x-axis at a positive x-value.', 'The graph of the function $f$ is shown, where $y = f(x)$. What is the $y$-intercept of the graph?', '{"A":"$(0, -1)$","B":"$(0, -4)$","C":"$(0, 1)$","D":"$(0, 4)$"}'::jsonb, '/data/tests/cb-og-6/figures/m4-q5.png', 'B', NULL, NULL, 45)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
