...
(Figure: Bar graph: “Percentage of Participants Who Mentioned Factors.” X-axis “Factor” with bars for convenience, costs, and established behaviors; Y-axis “Percent” 0–80.)', 'Bar graph: “Percentage of Participants Who Mentioned Factors.” X-axis “Factor” with bars for convenience, costs, and established behaviors; Y-axis “Percent” 0–80.', 'According to the graph, about what percentage of participants mentioned costs in the interviews?', '{"A":"10%","B":"95%","C":"25%","D":"50%"}'::jsonb, NULL, 'D', NULL, NULL, 8)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
(Figure: Bar graph: “Percentage of ULE Attributed to Population Growth and GDP per Capita Growth in Two World Regions.” Grouped bars (urban population growth, GDP per capita growth) for Region 1 and Region 2 across 1970–2000 and 2000–2014; Y-axis “Percentage attribution” 0–90.)', 'Bar graph: “Percentage of ULE Attributed to Population Growth and GDP per Capita Growth in Two World Regions.” Grouped bars (urban population growth, GDP per capita growth) for Region 1 and Region 2 across 1970–2000 and 2000–2014; Y-axis “Percentage attribution” 0–90.', 'Which choice most effectively uses data from the graph to complete the statement?', '{"A":"national governments of countries in Region 1 experienced declines in efficiency in the period from 2000 to 2014, relative to the period from 1970 to 2000.","B":"countries in Region 1 experienced a slower rate of economic growth in the period from 2000 to 2014 than countries in Region 2 did, despite increasing national government efficiency in Region 1.","C":"national governments of most countries in Region 2 became more efficient in the period from 2000 to 2014 than they had been in the period from 1970 to 2000, but those of several countries in this region did not.","D":"national governments of countries in Region 1 and in Region 2 generally became more efficient in the period from 2000 to 2014 than they had been in the period from 1970 to 2000, but at different rates."}'::jsonb, NULL, 'A', NULL, NULL, 11)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
The student wants to present an overview of the study''s findings.', NULL, 'Which choice most effectively uses relevant information from the notes to accomplish this goal?', '{"A":"The 2021 study determined the information rate (IR) of 17 languages in bits of information conveyed per second.","B":"Researchers found that information was conveyed more quickly in Spanish, at 7.7 syllables per second, than in Vietnamese, at 5.3 syllables per second.","C":"Vietnamese had the sixteenth-fastest syllable rate, lower than that of Spanish, which had the second-fastest; however, Spanish had the lower information rate of the two.","D":"Though some of the languages differed in number of syllables spoken per second, all 17 conveyed information at roughly the same rate."}'::jsonb, NULL, 'D', NULL, NULL, 18)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 8, '2-8', 8, 'mcq', 'The Bayeux Tapestry, from eleventh-century France, depicts 75 scenes over 250 feet of fabric. It was likely produced by workers embroidering in sections and then joining the resulting panels together. It''s plausible that the workshop that produced the tapestry had never produced one so large, and some researchers claim that a close examination of the joins—the places where the panels are stitched together—suggests that the workers developed and refined their joining process over the course of production. For example, the first join the workers completed exhibits a clear misalignment of the borders of the two panels, whereas the later joins are virtually invisible.', NULL, 'Which choice best describes the function of the underlined sentence in the text as a whole?', '{"A":"It identifies the people and events depicted in the Bayeux Tapestry.","B":"It supports an argument about the workers who produced the Bayeux Tapestry.","C":"It compares the Bayeux Tapestry with other tapestries from eleventh-century France.","D":"It describes how researchers determined where the Bayeux Tapestry was produced."}'::jsonb, NULL, 'B', NULL, NULL, 22)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
• This painting was completed in 1930.', NULL, 'The student wants to indicate the year Yosemite Falls was completed. Which choice most effectively uses relevant information from the notes to accomplish this goal?', '{"A":"While living in California, Obata created black ink paintings.","B":"Obata, a Japanese American artist, created a notable painting.","C":"Yosemite Falls was completed in 1930.","D":"Obata used a Japanese painting method called sumi-e."}'::jsonb, NULL, 'C', NULL, NULL, 31)
  ...
  RETURNING id INTO v_mod;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 1, '3-1', 1, 'mcq', 'The scatterplot shows the temperature, in degrees Fahrenheit ($\degree$F), and the distance above sea level, in feet, measured at 6 locations on Mount Jefferson. A line of best fit is also shown.

(Figure: Scatterplot with x-axis ''Distance above sea level (feet)'' marked 0, 2,000, 4,000, 6,000, 8,000 and y-axis ''Temperature ($\degree$F)'' marked from 0 to 80 in increments of 10. Six data points are plotted with a downward-sloping line of best fit; at 0 feet the line is near 60$\degree$F and it decreases as distance increases.)', 'Scatterplot with x-axis ''Distance above sea level (feet)'' marked 0, 2,000, 4,000, 6,000, 8,000 and y-axis ''Temperature ($\degree$F)'' marked from 0 to 80 in increments of 10. Six data points are plotted with a downward-sloping line of best fit; at 0 feet the line is near 60$\degree$F and it decreases as distance increases.', 'At a distance of 4,000 feet above sea level, what is the temperature, in $\degree$F, predicted by the line of best fit?', '{"A":"47","B":"35","C":"25","D":"0"}'::jsonb, NULL, 'B', NULL, NULL, 32)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
Which value is a solution to the given equation?', '{"A":"$\\frac{65}{61}$","B":"4","C":"126","D":"130"}'::jsonb, NULL, 'B', NULL, NULL, 32)
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 5, '3-5', 5, 'mcq', 'The bar graph summarizes the charge, in kilowatt-hours (kWh), a battery received each day for 15 days.

(Figure: Bar graph with x-axis ''Charge (kWh)'' showing categories 0, 8, 9, 11, 16, 23 and y-axis ''Number of days'' marked from 0 to 7. Bars indicate how many days each charge amount occurred.)', 'Bar graph with x-axis ''Charge (kWh)'' showing categories 0, 8, 9, 11, 16, 23 and y-axis ''Number of days'' marked from 0 to 7. Bars indicate how many days each charge amount occurred.', 'For how many of these 15 days did the battery receive a charge of 0 kWh?', '{"A":"0","B":"1","C":"4","D":"6"}'::jsonb, NULL, 'D', NULL, NULL, 33)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 8, '3-8', 8, 'mcq', 'The graph shown gives the estimated value, in dollars, of a tablet as a function of the number of months since it was purchased.

(Figure: Line graph with x-axis ''Number of months after purchase'' marked 0, 4, 8, 12, 16, 20, 24 and y-axis ''Value (dollars)'' marked 50, 100, 150, 200, 250, 300, 350. The line decreases from a y-intercept near 225 at month 0 down toward lower values as months increase.)', 'Line graph with x-axis ''Number of months after purchase'' marked 0, 4, 8, 12, 16, 20, 24 and y-axis ''Value (dollars)'' marked 50, 100, 150, 200, 250, 300, 350. The line decreases from a y-intercept near 225 at month 0 down toward lower values as months increase.', 'What is the best interpretation of the $y$-intercept of the graph in this context?', '{"A":"The estimated value of the tablet was \\$225 when it was purchased.","B":"The estimated value of the tablet 24 months after it was purchased was \\$225.","C":"The estimated value of the tablet had decreased by \\$225 in the 24 months after it was purchased.","D":"The estimated value of the tablet decreased by approximately 2.25% each year after it was purchased."}'::jsonb, NULL, 'A', NULL, NULL, 33)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 11, '3-11', 11, 'mcq', 'The graph of a system of an absolute value function and a linear function is shown.

(Figure: Graph in the $xy$-plane showing a V-shaped absolute value function and a straight line. The x-axis is marked from $-8$ to $3$ and the y-axis from 1 to 9. The two graphs intersect at a single point near $(-3, 4)$.)', 'Graph in the $xy$-plane showing a V-shaped absolute value function and a straight line. The x-axis is marked from $-8$ to $3$ and the y-axis from 1 to 9. The two graphs intersect at a single point near $(-3, 4)$.', 'What is the solution $(x, y)$ to this system of two equations?', '{"A":"$(0, 8)$","B":"$\\left(\\frac{7}{2}, \\frac{9}{2}\\right)$","C":"$\\left(-\\frac{7}{2}, \\frac{9}{2}\\right)$","D":"$(-3, 4)$"}'::jsonb, NULL, 'C', NULL, NULL, 34)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
...
The given equation relates the variables $n$, $t$, and $w$, where $n > 0$, $t > 0$, and $w > t$.', NULL, 'Which expression is equivalent to $n$ ?', '{"A":"$12tw$","B":"$6(t - w)$","C":"$\\frac{w - t}{6tw}$","D":"$\\frac{6tw}{w - t}$"}'::jsonb, NULL, 'D', NULL, NULL, 36)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 20, '3-20', 20, 'grid', 'During a study, the temperature, in degrees Celsius ($\degree$C), of the air in a chamber was recorded to the nearest integer at certain times. The scatterplot shows the recorded temperature $y$, in $\degree$C, of the air in the chamber $x$ minutes after the start of the study.

(Figure: Scatterplot with x-axis ''Time (minutes)'' marked 0 through 8 and y-axis ''Temperature ($\degree$C)'' marked in increments of 2 from 0 to 30. Data points show recorded temperatures at various times.)', 'Scatterplot with x-axis ''Time (minutes)'' marked 0 through 8 and y-axis ''Temperature ($\degree$C)'' marked in increments of 2 from 0 to 30. Data points show recorded temperatures at various times.', 'What was the average rate of change, in $\degree$C per minute, of the recorded temperature of the air in the chamber from $x = 5$ to $x = 7$ ?', NULL, NULL, '5', '["5"]'::jsonb, NULL, 36)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  ...
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    ...
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
  INSERT INTO public.test_questions (module_id, position, ref, number, type, passage, passage_alt, stem, choices, figure, correct_answer, accepted, domain, source_page)
  VALUES (v_mod, 3, '4-3', 3, 'mcq', '(Figure: An upward-opening parabola on an xy-coordinate plane. The x-axis ranges from about -2 to 2 and the y-axis is labeled from -1 to 12. The curve''s lowest point (vertex) is at (0, 2), and the parabola rises symmetrically on both sides, passing through about (-2, 10) and (2, 10).)', 'An upward-opening parabola on an xy-coordinate plane. The x-axis ranges from about -2 to 2 and the y-axis is labeled from -1 to 12. The curve''s lowest point (vertex) is at (0, 2), and the parabola rises symmetrically on both sides, passing through about (-2, 10) and (2, 10).', 'The graph of the quadratic function $y = f(x)$ is shown. What is the vertex of the graph?', '{"A":"$(0, -2)$","B":"$(0, -3)$","C":"$(0, 2)$","D":"$(0, 3)$"}'::jsonb, NULL, 'C', NULL, NULL, 44)
  ON CONFLICT (module_id, position) DO UPDATE SET ref=EXCLUDED.ref, number=EXCLUDED.number, type=EXCLUDED.type,
    passage=EXCLUDED.passage, passage_alt=EXCLUDED.passage_alt, stem=EXCLUDED.stem, choices=EXCLUDED.choices,
    figure=EXCLUDED.figure, correct_answer=EXCLUDED.correct_answer, accepted=EXCLUDED.accepted,
    domain=EXCLUDED.domain, source_page=EXCLUDED.source_page;
